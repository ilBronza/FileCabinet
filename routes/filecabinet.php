...
Route::group([
	...
	function()
	{
		...
		{
			Route::get('{dossier}/show-files', [FileCabinet::getController('dossier', 'showFiles'), 'showFiles'])->name('dossiers.showFiles');

			//DossierDownloadFileController
			Route::get('{dossier}/download-files', [FileCabinet::getController('dossier', 'downloadFiles'), 'downloadFiles'])->name('dossiers.downloadFiles');
